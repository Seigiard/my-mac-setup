.PHONY: help test-python test-ubuntu test-local test-suite test-docker test-templates test-pi-agents-local test-agents-local-opencode test-herdr-resource-context-opencode test-pi-brew-auto-update test-pi-herdr-worktree-identity test-agent-hooks-core test-agent-hooks-opencode test-agent-hooks-pi lint clean build-docker shell-ubuntu
