...
<examples>
- ✅ Separate commits: "Add login API endpoint" and "Update README with login docs"
- ✅ Single commit: "Add user model with migration and tests" (tightly coupled changes)
- ✅ Separate commits: "Fix authentication bug" and "Refactor settings page"
</examples>

<exceptions>
- ❌ Huge commits bundling unrelated changes ("Add feature + fix bug + update docs")
- ❌ Splitting tightly coupled changes that break without each other
- ❌ Vague commit messages like "fixes", "updates", or "changes"
</exceptions>
