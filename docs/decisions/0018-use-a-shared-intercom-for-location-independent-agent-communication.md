...
marks managed child-launch context, not an Intercom address. The upstream
`HERDR_CHILD_NAME` compatibility boundary is documented in the child-agent
contract. A missing record, provisional
