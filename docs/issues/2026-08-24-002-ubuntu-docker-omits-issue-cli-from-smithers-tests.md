...
Mounted and staged scripts/issues plus docs/issues in both full Docker services, created the disposable worktree marker required by the CLI, and added a Docker contract regression. Verified with make test-ubuntu: 626 Smithers tests and 362 post-apply Bats tests passed.
