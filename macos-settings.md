...
- Keyboard:
  ...
  - Keyboard Shortcuts:
    - Launchpad & Doc: Uncheck All
    - Display: Uncheck All
    - Mission Control: Only [x] Mission Control, [x] Application windows
    - Keyboard: Only [x] Move focus to the next window
    - Input Sources: Uncheck All
    - Screenshots: Uncheck All
    - Presenter Overlay: Uncheck All
    - Services: Uncheck All
    - Spotlight: Uncheck All
